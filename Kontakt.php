...
<head>
	...
	<body>
		...
		<br><br><br><br><br>
		<p class="rec">"...MoSa RajoSa..." </p>

	<p class="kontakt">
		<strong>Kontakt:  </strong> adin.velic@gmil.com
	</p>	
    <br>
    <p class="kontakt">
    ...
    <ul class="lista" >
					<li><a class="active" href="http://www.fksinfo.com/" > FKS info</a></li>
					<li><a class="active" href="http://sportsport.ba/" > Sport sport</a></li>
					<li><a class="active" href="http://www.hordezla.ba/" > Horde Zla</a></li>
					
				</ul>
    	
    </div>
    <img class="zid" src="zid.jpg" alt="zid">
